...
// in cursor_test_flutter/test/features/todo/presentation/bloc/todo_bloc_test.dart.
...
class MockTodoRepository extends _i1.Mock implements _i2.TodoRepository {
  ...
  @override
  _i3.Future<_i4.Todo?> getTodoById(String? id) => (super.noSuchMethod(
        Invocation.method(
          #getTodoById,
          [id],
        ),
  ...
  @override
  _i3.Future<void> updateTodo(_i4.Todo? todo) => (super.noSuchMethod(
        Invocation.method(
          #updateTodo,
          [todo],
        ),
